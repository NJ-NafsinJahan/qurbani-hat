...
const livestockDetailsPage = async ({ params }) => {
  ...
  return (
    <div className="">
      <h1 class="animate__animated animate__bounce animate__infinite	infinite animate__slow	3s text-5xl text-center mt-10 font-bold bg-linear-to-r from-[#1ab45a] to-[#0f9d58] bg-clip-text text-transparent ">
        LiveStock Details
      </h1>
      <div className="container mx-auto min-h-screen flex justify-center items-center ">
        <div className="grid md:grid-cols-2 gap-6 bg-base-100 shadow-md rounded-2xl max-w-4xl w-full">
